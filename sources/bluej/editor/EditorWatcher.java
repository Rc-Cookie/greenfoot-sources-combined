...
public interface EditorWatcher
{
     ...
     */
    void recordStrideEdit(String javaSource, String strideSource, Object reason);
     ...
     */
    void recordEarlyErrors(List<?> diagnostics, int compilationIdentifier);

    /**
     * Record a list of late errors that were found.
     */
    void recordLateErrors(List<?> diagnostics, int compilationIdentifier);
     ...
     */
    void recordShowHideFrameCatalogue(String enclosingFrameXpath, int cursorIndex, boolean show, Object reason);
     ...
     * @param reason               The user interaction which triggered the change.
     */
    void recordViewModeChange(String enclosingFrameXpath, int cursorIndex, Object oldView, Object newView, Object reason);
