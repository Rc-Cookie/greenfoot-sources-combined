...
public class JavaFXUtil
{
     ...
     */
    private static final Object measured = null;
    ...
    private static class TooltipListener implements EventHandler<InputEvent>, FXPlatformConsumer<Boolean>
    {
         ...
         */
        @OnThread(Tag.FX)
        private TooltipListener(Object editor, Node parent, FXConsumer<FXConsumer<String>> requestTooltip)
        {
            this.editor = editor;
            this.parent = parent;
     ...
     */
    public static void initializeCustomHelp(Object editor, Node parent, FXConsumer<FXConsumer<String>> requestTooltip, boolean onHoverToo)
    {
     ...
     */
    @OnThread(Tag.FXPlatform)
    public static <T6> void onceNotNull(ObservableValue<T6> observable, Consumer<T6> callback)
    {
     ...
     */
    @OnThread(Tag.FX)
    public static <T> void onceBecomesNotNull(ObservableValue<T> observable, Consumer<T> callback)
    {
    ...
    @OnThread(Tag.FX)
    @SuppressWarnings("threadchecker")
    public static <T> Runnable addChangeListenerPlatform(ObservableValue<T> property,
            Consumer<T> listener)
    {
        ChangeListener<T> wrapped = (a, b, newVal) -> listener.accept(newVal);
        property.addListener(wrapped);
    ...
    {
        return () -> Arrays.stream(actions).forEach(Runnable::run);
    }
    ...
    @OnThread(Tag.Swing)
    private static FXPlatformSupplier<Menu> swingMenuToFX(JMenu swingMenu, Object source, Object extraConvert)
    {
     ...
     */
    @OnThread(Tag.Swing)
    public static FXPlatformSupplier<Menu> swingMenuToFX(List<JMenuItem> swingMenuItems, Object source, FXPlatformSupplier<Menu> createMenu, Object extraConvert)
    {
        return null;
    }
    
    @OnThread(Tag.Swing)
    public static FXPlatformRunnable swingMenuItemsToContextMenu(ContextMenu destination, List<JMenuItem> swingItems, Object source, Object extraConvert)
    {
        return null;
    }
