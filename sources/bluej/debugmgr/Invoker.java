    ...
    implements FXCompileObserver
{
     ...
     */
    public Invoker(Object pmf, ValueCollection localVars, String command, ResultWatcher watcher)
    {
     ...
     */
    public Invoker(Object pmf, CallableView member, ResultWatcher watcher)
    {
        this(null, null, member, watcher, null, null,
                null, null, null);
     ...
     *            an object interested in the result of the invocation
     */
    public Invoker(Object pmf, MethodView member, String objName, DebuggerObject debuggerObject, ResultWatcher watcher)
    {
     ...
     */
    private Invoker(final Object pmf, CallableView member, String instanceName, Map<String, GenTypeParameter> typeMap)
    {
        this.member = member;
        this.instanceName = instanceName;
        ...
        this.pkgPath = null;
        this.pkgName = null;
        this.pkgScopeId = null;
        this.callHistory = null;
        this.objectBenchVars = null;
        this.objectBench = null;
        this.debugger = null;
